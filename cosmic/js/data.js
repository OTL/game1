...
const BALANCE = {
  ...
  // 実機フィードバック対応（重力が強すぎる）: 5.0倍では画面半分先の獲物まで一瞬で
  // 吹き飛ぶように加速してしまっていた。「近づいたものがすっと吸われる」程度に
  // 弱め、GRAV_PLAYER_RANGE（有効射程）・GRAV_MAX_ACCEL（加速度上限）自体も
  // 下げて遠距離からの急接近を抑える。
  preyGravityBoost: 2.2,      // 獲物（およびブラックホール中の全天体）に働く径方向重力の倍率
